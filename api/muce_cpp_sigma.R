...
sourceCpp(file = "muce_function_sigma.cpp")
...
runsimFun = function(seed, simN, ndose, ntype, q0, q1, p.true, cohortsize,
                   ...
                   param = list(scale1 = 2.5, scale3 = 2.5, # the prior for \theta
                                eta_lambda1 = 0.0005, eta_lambda2 = 0.000005, 
                                mu = 0)){
  
  scale1 = param$scale1 
  scale3 = param$scale3
  mu = param$mu
  eta_lambda1 = param$eta_lambda1
  eta_lambda2 = param$eta_lambda2
  ...
  for (sim in 1:simN) {
    ...
    for(i in 1:ncohort){
      ...
      #                    mcmcsize)
      mcmc.r = muce_mcmc_basket_v2(seed=seed+sim,
                                   nbasket, b.y, samplesize, theta0, theta1,
                                   scale1, scale3, mu, c0 = 1, eta_lambda1, eta_lambda2,
                                   sigma.theta, mcmcsize)
